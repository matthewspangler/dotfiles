...
theme.bg_focus      = pywal.color4
theme.bg_urgent     = pywal.color5
theme.bg_minimize   = pywal.color2
...
theme.border_normal = pywal.color0
theme.border_focus  = pywal.color2
theme.border_marked = pywal.color5
